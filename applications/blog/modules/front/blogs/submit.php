...
class _submit extends \IPS\Dispatcher\Controller
{
	...
	protected function manage()
	{
		...
		try
		{
			...
			\IPS\Session::i()->setLocation( $this->blog->url(), array(), 'loc_blog_adding_entry', $this->blog->member_id ? array( $this->blog->_title => FALSE ) : array( "blogs_blog_{$this->blog->id}" => TRUE ) );
