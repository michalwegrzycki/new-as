...
class _admin extends \IPS\Dispatcher\Controller
{
	...
	public function manage()
	{
		...
		$form->add( new \IPS\Helpers\Form\Password( 'admin_pass1', NULL, TRUE, array( 'maxLength' => 50 ) ) );
		$form->add( new \IPS\Helpers\Form\Password( 'admin_pass2', NULL, TRUE, array( 'maxLength' => 50, 'confirm' => 'admin_pass1' ) ) );
