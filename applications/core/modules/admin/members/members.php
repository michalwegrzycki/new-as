...
class _members extends \IPS\Dispatcher\Controller
{
	...
	public function delete()
	{
		...
		if ( $member->member_posts )
		{
			...
			\IPS\Member::loggedIn()->language()->words['keep_name'] = sprintf( \IPS\Member::loggedIn()->language()->get('keep_name'), htmlspecialchars( $member->name, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', false ) );
