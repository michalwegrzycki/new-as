...
class _Twitter extends ProfileSyncAbstract
{
	...
	protected function user()
	{
		if ( ( $this->user === NULL ) and $this->member->twitter_token )
		{
			...
			catch ( \Exception $e )
			{
				...
				\IPS\Log::log( isset( $this->user['errors'] ) ? var_export( $this->user['errors'], true ) : $e, 'twitter' );
			}
		}
	...
	{
		return $invert ? array( '( twitter_id IS NULL or twitter_id = 0 )' ) : array( 'twitter_id > 0' );
	}
}