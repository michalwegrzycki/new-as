...
class _Upgrade
{
	...
	public function step3()
	{
		\IPS\Db::i()->update( 'core_sys_conf_settings', array( 
			'conf_value' => (int) \IPS\Db::i()->select( 'count(*)', 'core_ipsconnect_slaves' )->first()
		), array( 'conf_key=?', 'connect_slaves' ) );
	...
	{
		return "Resetting IPS Connect slave count";
	}
