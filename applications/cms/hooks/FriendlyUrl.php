...
class cms_hook_FriendlyUrl extends _HOOK_CLASS_
{
	...
	{		
		...
		if ( $return = call_user_func_array( 'parent::createFriendlyUrlFromComponents', func_get_args() ) or !$potentialFurl )
		{
	...
	public static function friendlyUrlFromQueryString( $queryString, $seoTemplate, $seoTitles, $protocol )
	{
		...
		return call_user_func_array( 'parent::friendlyUrlFromQueryString', func_get_args() );
	}
	...
	{		
		...
		return call_user_func_array( 'parent::setFriendlyUrlData', func_get_args() );
	}
