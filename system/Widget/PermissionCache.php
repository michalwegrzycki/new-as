...
class _PermissionCache extends \IPS\Widget
{
	...
	public function __construct( $uniqueKey, array $configuration, $access=null, $orientation=null )
	{
		...
		$permissions = \IPS\Member::loggedIn()->permissionArray();
		...
		$this->cacheKey = "widget_{$this->key}_" . $this->uniqueKey . '_' . md5( json_encode( $configuration ) . "_" . \IPS\Member::loggedIn()->language()->id . "_" . \IPS\Member::loggedIn()->skin . "_" . json_encode( $permissions ) . "_" . $orientation );
	}
}