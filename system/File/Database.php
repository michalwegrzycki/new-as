...
class _Database extends \IPS\File
{
	...
	{
		/* Ensure any existign files with this name are removed otherwise the wrong file may be selected from the database as it will store multiple copies when replace() is used */
